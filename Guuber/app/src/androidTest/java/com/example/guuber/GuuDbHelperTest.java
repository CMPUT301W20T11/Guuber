...
//    fails when run all test passes when ran individually
    ...
    public void createRequestTest() throws InterruptedException{
        ...
        Thread.sleep(1000);
        //tdbHelper.makeReq(user, (double) 60, 0000,0000,1000,1000,"5050");
        Thread.sleep(1000);
    ...
    public void requestTest() throws InterruptedException{
        ...
        User user = dbHelper.getUser("m@gmail.com");
        Thread.sleep(1000);
        //tdbHelper.makeReq(user, (double) 60,0000,0000,1000,1000,"60");
        Thread.sleep(1000);
        user = dbHelper.getUser("k@gmail.com");
        Thread.sleep(1000);
        //tdbHelper.makeReq(user, (double) 10,9999,9999,7777,7777,"100");
        Thread.sleep(1000);
    ...
    public void RequestComTest() throws InterruptedException{
        ...
        Thread.sleep(1000);
        //tdbHelper.makeReq(mockUser2(),(double)10,69.312031230,72.01230345,30.12031204,50.12312415,"20");
        Thread.sleep(1000);
